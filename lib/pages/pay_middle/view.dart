    ...
    return Scaffold(
      ...
      body: Obx(() {
        ...
        String url = EnvConfig.env.apiUrl +
            '/index/index/payform' +
            "?charset=${thirdPayModel.data.charset}&signType=${thirdPayModel.data.signType}&data=${Uri.encodeComponent(thirdPayModel.data.data)}&sign=${thirdPayModel.data.sign}";
        // String url =
        //     "https://cashier.sandpay.com.cn/gw/web/order/toIndex?p=UHWOtxlSetuS1YbjJ97EK3LGlmxohw%2BLAWZXRCGe4ypCyRFtq4c8CRSjqlu1OKwzrk4cycR1u5EdYMEX9tBVZBMWrSHH2DvdN6fpbDiRvFD6bhq%2FXRL72gUyj9ufEXConpIqgrTagLOoQHkcEohUZydrzgWL%2FgjVM0dATXIKvTT9ErigSGabZGIiXfDKkMTId8Zka8XYuquSmwO0fYzDQUZ8pwhvZs00#";
